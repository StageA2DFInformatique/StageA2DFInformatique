...
foreach ($LesVentes as $uneVente) {
    ...
    echo "
		...
		<tr class='ligneTabNonQuad'>
         ...
         <a href='cSemaine3.php?action=detailVente&id=$id'>
                    <img src='./images/detail.png'title='Voir détail' />
        </a></td>  
                 <td width='16%' align='center'> 
        <a href='cSemaine3.php?action=demanderModifierVente&id=$id'>
                    <img src='./images/modifier.png'title='Modifier' />
        </a></td>
         <td width='16%' align='center'> 
        <a href='cSemaine3.php?action=demanderSupprimerVente&id=$id'>
...
echo "
    ...
    <br>
        <a href = 'cSemaine3.php?action=demanderSupprimerTouteVente'>
    Réinitialiser semaine N°3 </a ><br>
    
    <a href = 'cSemaine3.php?action=totalSemaine3'>
    Voir le total de la semaine N°3 </a >";
