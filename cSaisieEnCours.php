...
switch ($action) {
    case 'initial' :
        include("vues/EnCours/vObtenirEnCours.php");
        break;

    case 'detailVente':
        $id = $_REQUEST['id'];
        include("vues/EnCours/vObtenirDetailEnCours.php");
        break;

    case 'demanderSupprimerVente':
        $id = $_REQUEST['id'];
        include("vues/EnCours/vSupprimerEnCours.php");
        break;

    case 'demanderCreerVente':
        include("vues/EnCours/vCreerModifierEncours.php");
        break;
